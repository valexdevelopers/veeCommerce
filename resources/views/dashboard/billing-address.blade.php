...
<html>
    <head>
        <title>Address | Vee Commerce </title>
                    ...
                    <div class="row-l dashboard-wrap">
                        ...
                        <div class="otherinfo">
                            ...
                            <div class="address-wrap">
                                ...
                                @endif
                                <form method="post" action="{{ route('auth.user.address.create') }}" >
                                    @csrf
                                    ...
                                    <div class="row form-row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input required="required" class="form-control @error('billing_firstname') is-invalid @enderror"   required="required" type="text" name="billing_firstname"  value="{{ $address->firstname }}">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" required="required" class="form-control @error('billing_lastname') is-invalid @enderror"  name="billing_lastname" placeholder=""  value="{{ $address->lastname}}">
                                    ...
                                    <div class="row form-row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group ">
                                                ...
                                                <input type="text" id="billing_street" required="required" class="form-control @error('billing_street') is-invalid @enderror"  name="billing_street" placeholder=""  value="{{ $address->street}}">
                                    ...
                                    <div class="row form-row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group ">
                                                ...
                                                <input type="text" id="billing_apartment"  class="form-control @error('billing_apartment') is-invalid @enderror"  name="billing_apartment" placeholder="Apartment, suite, unit etc "  value="{{ $address->apartment}}">
                                    ...
                                    <div class="row form-row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group ">
                                                ...
                                                <select class="form-select"  id="country" name="billing_country" required="required">
                                    ...
                                    <div class="row form-row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input required="required" class="form-control @error('billing_phone') is-invalid @enderror"   required="required" type="tel" name="billing_phone"  value="{{ $address->mobile}}">
                                            @error('billing_phone')
                                                <div class="help-block form-text with-errors form-control-feedback">{{$message}}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group ">
                                                ...
                                                <input type="text" required="required" class="form-control @error('billing_region') is-invalid @enderror"  name="billing_region" placeholder=""  value="{{ $address->region}}">
                                    ...
                                    <div class="row form-row " >
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group ">
                                                ...
                                                <input type="text" required="required" class="form-control @error('billing_city') is-invalid @enderror" id="billing_city" name="billing_city" placeholder=""  value="{{ $address->town}}">
                                            @error('billing_city')
                                                <div class="help-block form-text with-errors form-control-feedback">{{$message}}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group ">
                                                ...
                                                <input type="text" id="billing_postalcode" required="required" class="form-control @error('billing_postalcode') is-invalid @enderror"  name="billing_postalcode" placeholder=""  value="{{ $address->postal_code}}">
                                    ...
                                    <div class="col-sm-12 d-flex movebtnleft">
                                        <button class="btn btn-primiary" type="submit" name="premier"> Change Address</button>
                                    </div>
                                </form>
                            </div>
                        </div>
