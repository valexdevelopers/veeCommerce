                                ...
                                <div class="header-details">
                                    <div>
                                        <div class="order-id-wrap">
                                            <h6 class="">New Brand </h6>
                                            
                                        </div>
                                        
                                       <small class="order-extra-details">Add new brands here</small>
                                    </div>
                                            ...
                                            <div class=" grid-col-70 ">
                                                ...
                                                <div class="product-image-dropzone mt-20 mt-20-sm mt-20 mt-20-sm with-box-shadow white-bg rounded-edges padding-20">
                                                    ...
                                                    <div class="file-upload-wrapper">
                                                        ...
                                                        <input name="brand_image" accept="image" type="file" id="banner-images-input" class="product-image-upload file-upload @error('brand_image') is-invalid  @enderror" data-height="500" />
                                                        @error('brand_image')
                                                    ...
                                                    <div class="row form-row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="brand_name" class="form-control @error('brand_name') is-invalid @enderror " placeholder="Brand name">
                                                                @error('brand_name')
                                                                    <div class="help-block form-text with-errors form-control-feedback">{{$message}}</div>
                                                                @enderror
                                                            </div>
