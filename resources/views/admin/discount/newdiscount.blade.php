...
<html>
    <head>
        <title>New Discount Sales | Admin</title>
                            ...
                            <div>
                                <div class="header-details">
                                    <div>
                                       ...
                                       <small class="order-extra-details">Run Sales here</small>
                                    </div>
                                    <div class="delete-order-container">
                                        <div><a href="{{ route('admin.discount') }}" class="red-bg color-red button-1 no-text-deco">View Sales</a></div>
                                    </div>
                                </div>
                                <div class="padding-5">
                                    @if($errors->any())
                                                    ...
                                                    <div class="row form-row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                @include('layouts.salesProductSelection')
                                                                ...
                                                                <select class="form-select"  id="country" name="product_category"  >
                                                                    <option value="" id="selectProductsbtn">Select Product Category</option>
